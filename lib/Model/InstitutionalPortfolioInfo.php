...
/**
 * InstitutionalPortfolioInfo Class Doc Comment
 *
 * @category Class
 * @package  Finnhub
 * @author   OpenAPI Generator team
 ...
 */
class InstitutionalPortfolioInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstitutionalPortfolioInfo';
     ...
     * Sets name
     *
     * @param string|null $name Position's name.
     *
     * @return self
     */
