...
/**
 * BreakdownItem Class Doc Comment
 *
 * @category Class
 * @package  Finnhub
 * @author   OpenAPI Generator team
 ...
 */
class BreakdownItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BreakdownItem';
     ...
     * Sets access_number
     *
     * @param string|null $access_number Access number of the report from which the data is sourced.
     *
     * @return self
     */
     ...
     * Sets breakdown
     *
     * @param object|null $breakdown breakdown
     *
     * @return self
     */
