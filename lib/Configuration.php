...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://finnhub.io/api/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.1.16/PHP';
    ...
    {
        $report  = 'PHP SDK (Finnhub) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.1.16' . PHP_EOL;
